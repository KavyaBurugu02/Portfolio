        ...
        <div className="section-fade max-w-2xl">
          ...
          <div className="mt-8 space-y-4">
            ...
            >
              ...
              <div>
                <div className="text-xs text-muted font-mono uppercase tracking-wider">LinkedIn</div>
                <div className="text-accent text-sm mt-0.5">linkedin.com/in/kavyaburugu</div>
              </div>
              <svg
                className="ml-auto text-muted group-hover:text-accent transition-colors"
                width="16"
            ...
            <a
              href="https://github.com/KavyaBurugu02"
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-4 p-4 rounded-xl border border-border bg-surface hover:border-accent/40 transition-colors group"
            >
              ...
              <div>
                <div className="text-xs text-muted font-mono uppercase tracking-wider">GitHub</div>
                <div className="text-accent text-sm mt-0.5">github.com/KavyaBurugu02</div>
              </div>
              <svg
                className="ml-auto text-muted group-hover:text-accent transition-colors"
                width="16"
